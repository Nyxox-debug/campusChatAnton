...
<div class="app">
  ...
  <header class="header">
    <div class="header-brand">
      ...
      <div class="logo" aria-hidden="true">
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
          ...
          <path d="M2 15.5l10 5.5 10-5.5" stroke="#fff" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/>
          <path d="M2 12l10 5.5 10-5.5" stroke="rgba(255,255,255,0.45)" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
      </div>
    ...
    <div class="header-actions">
      <a href={GITHUB_URL} target="_blank" rel="noopener noreferrer" class="gh-link" aria-label="View source">
      ...
      {#if selectedRole}
        <button class="pill-btn" on:click={switchRole}>Switch role</button>
      {/if}
    </div>
  </header>
  ...
  {#if !selectedRole}
    <div class="role-screen">
      <div class="role-content">
        ...
        <p class="hero-sub">Get instant answers tailored to your role</p>
          ...
          <button class="role-card" on:click={() => selectRole('student')}>
            <div class="role-card-inner">
              ...
              <div class="rc-text">
                ...
                <span class="rc-desc">Fees · Results · Registration · Hostel</span>
              </div>
              <div class="rc-arrow">
            ...
            <div class="role-card-inner">
              <div class="rc-icon staff-icon">
                <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  <path d="M4 20c0-4 3.6-7 8-7s8 3 8 7" opacity="0.6"/>
                </svg>
              </div>
              <div class="rc-text">
                <span class="rc-title">Staff</span>
                <span class="rc-desc">Payroll · Leave · IT · Procurement</span>
              </div>
              <div class="rc-arrow">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round">
                  <path d="M9 18l6-6-6-6"/>
        ...
        <div class="screen-footer">
          ...
          <a href={GITHUB_URL} target="_blank" rel="noopener noreferrer" class="footer-gh">
...
<style>
  ...
  .gh-link:hover { color: #ccc; border-color: #333; }
  ...
  .pill-btn:hover { color: #fff; border-color: #444; }
  ...
  .messages::-webkit-scrollbar-thumb { background: #1e1e1e; border-radius: 3px; }
